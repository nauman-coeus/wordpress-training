...
<head>
    ...
    <link href="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>css/bootstrap.css" rel="stylesheet">
    <link href="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>css/fontawesome-all.css" rel="stylesheet">
    <link href="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>css/swiper.css" rel="stylesheet">
	<link href="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>css/magnific-popup.css" rel="stylesheet">
	<link href="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>css/styles.css" rel="stylesheet">
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/logo.svg" alt="alternative"></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="image-container">
                        <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/intro-office.jpg" alt="alternative">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/services-1.jpg" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/services-2.jpg" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/services-3.jpg" alt="alternative">
                        </div>
                        <div class="card-body">
                        ...
                        <div class="swiper-container card-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/testimonial-1.jpg" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/testimonial-2.jpg" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/testimonial-3.jpg" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/testimonial-4.jpg" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/testimonial-5.jpg" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/testimonial-6.jpg" alt="alternative">
                                        <div class="card-body">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="grid">
                        <div class="element-item development">
                            <a class="popup-with-move-anim" href="#project-1"><div class="element-item-overlay"><span>Online Banking</span></div><img src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-1.jpg" alt="alternative"></a>
                        </div>
                        <div class="element-item development">
                            <a class="popup-with-move-anim" href="#project-2"><div class="element-item-overlay"><span>Classic Industry</span></div><img src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-2.jpg" alt="alternative"></a>
                        </div>
                        <div class="element-item design development marketing">
                            <a class="popup-with-move-anim" href="#project-3"><div class="element-item-overlay"><span>BoomBap Audio</span></div><img src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-3.jpg" alt="alternative"></a>
                        </div>
                        <div class="element-item design development marketing">
                            <a class="popup-with-move-anim" href="#project-4"><div class="element-item-overlay"><span>Van Moose</span></div><img src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-4.jpg" alt="alternative"></a>
                        </div>
                        <div class="element-item design development marketing seo">
                            <a class="popup-with-move-anim" href="#project-5"><div class="element-item-overlay"><span>Joy Moments</span></div><img src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-5.jpg" alt="alternative"></a>
                        </div>
                        <div class="element-item design marketing seo">
                            <a class="popup-with-move-anim" href="#project-6"><div class="element-item-overlay"><span>Spark Events</span></div><img src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-6.jpg" alt="alternative"></a>
                        </div>
                        <div class="element-item design marketing">
                            <a class="popup-with-move-anim" href="#project-7"><div class="element-item-overlay"><span>Casual Wear</span></div><img src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-7.jpg" alt="alternative"></a>
                        </div>
                        <div class="element-item design marketing">
                            <a class="popup-with-move-anim" href="#project-8"><div class="element-item-overlay"><span>Zazoo Apps</span></div><img src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-8.jpg" alt="alternative"></a>
                        </div>
                    </div> <!-- end of grid -->
                    <!-- end of filter -->
    ...
    <div id="project-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            ...
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-1.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
    ...
    <div id="project-2" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-2.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
    ...
    <div id="project-3" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-3.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>BoomBap Audio</h3>
                <hr class="line-heading">
    ...
    <div id="project-4" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-4.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Van Moose</h3>
                <hr class="line-heading">
    ...
    <div id="project-5" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-5.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Joy Moments</h3>
                <hr class="line-heading">
    ...
    <div id="project-6" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-6.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Spark Events</h3>
                <hr class="line-heading">
    ...
    <div id="project-7" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-7.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Casual Wear</h3>
                <hr class="line-heading">
    ...
    <div id="project-8" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/project-8.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Zazoo Apps</h3>
                <hr class="line-heading">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/team-1.png" alt="alternative">
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/team-2.png" alt="alternative">
                        </div> <!-- end of image wrapper -->
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/team-3.png" alt="alternative">
                        </div> <!-- end of image wrapper -->
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/team-4.png" alt="alternative">
                        </div> <!-- end of image wrapper -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-xl-6">
                    <div class="image-container">
                        <img class="img-fluid" src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>images/about.jpg" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
    ...
    <!-- Scripts -->
    <script src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>js/jquery.min.js"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>js/popper.min.js"></script> <!-- Popper tooltip library for Bootstrap -->
    <script src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>js/bootstrap.min.js"></script> <!-- Bootstrap framework -->
    <script src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>js/jquery.easing.min.js"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>js/swiper.min.js"></script> <!-- Swiper for image and text sliders -->
    <script src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>js/jquery.magnific-popup.js"></script> <!-- Magnific Popup for lightboxes -->
    <script src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>js/morphext.min.js"></script> <!-- Morphtext rotating text in the header -->
    <script src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>js/isotope.pkgd.min.js"></script> <!-- Isotope for filter -->
    <script src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>js/validator.min.js"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
    <script src="<?=get_site_url() . '/wp-content/themes/MyCustomTheme/assets/';?>js/scripts.js"></script> <!-- Custom scripts -->
</body>
</html>